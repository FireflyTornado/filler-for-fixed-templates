...
- **日历选取日期** → 在模板内容框下方手动输入 `yyyy-MM-dd`，或打开弹出日历选择日期；日历支持年月快捷切换、年份/月份三级选择、周数与周日标记；`{{选取今日年}}`、`{{选取今日年月}}`、`{{选取今日年月日}}` 取选中日期，`{{选取昨日年}}`、`{{选取昨日年月}}`、`{{选取昨日年月日}}` 取选中日期的前一天；可一键“回到今日”
...
| `{{选取今日年}} {{选取今日年月}} {{选取今日年月日}}` | 获取日历选中的日期 | `{{选取今日年月日}}` |
| `{{选取昨日年}} {{选取昨日年月}} {{选取昨日年月日}}` | 获取日历选中日期的前一天 | `{{选取昨日年月日}}` |
| `[[字符串名]]` | 多行文本，原样输出 | `[[备注]]` |
